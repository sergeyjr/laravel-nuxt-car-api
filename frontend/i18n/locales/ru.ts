export default {
    ...
    auth: {
        ...
        invalidCredentials: 'Имя пользователя и пароль не совпадают',
        loggingIn: 'Входим...',
        login: 'Войти',
        loginLink: 'Войти',
        ...
        registerSuccess: 'Регистрация успешно завершена! Теперь вы можете войти',
    ...
    contact: {
        ...
        tooManyRequests: 'Подождите {sec} сек. перед следующим сообщением.',
    ...
    profile: {
        ...
        email: 'Email',
        emailChangeForbidden: 'Изменение email запрещено. Обратитесь в администрацию.',
